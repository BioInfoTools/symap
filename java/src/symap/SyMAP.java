...
public class SyMAP {
	...
	public static final int HISTORY_SIZE = 10;//100;
	...
	throws SQLException 
	{
		...
		if (applet != null) {
			...
			try {
				...
				{
					url = new URL("http://www.symapdb.org/cgi-bin/image_creator.cgi"); 					
				}
			} 
		...
		if (hb == null)
			...
			helpBar = hb; // mdb added 2/13/09 for 3D
	...
	public static void printVersion() {
		System.out.println("SyMAP Version " + VERSION);
